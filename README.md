...
- JavaScript
  ...
  - [llama2js](https://github.com/jellehak/llama2.js) by @[jellehak](https://github.com/jellehak): a JavaScript port of this project / @[epicure](https://github.com/epicure) to be used as a library for browser or nodejs
- Zig
